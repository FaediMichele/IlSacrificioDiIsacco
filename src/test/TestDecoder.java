...
public class TestDecoder {
    ...
    public void testDecoder() throws InstantiationException, IllegalAccessException, NoSuchMethodException,
        ...
        Class<?> s = Class.forName("test.TestControllerEntityView");
        TestEntityController e = (TestEntityController) s.newInstance();
        Method m = e.getClass().getMethod("test", String.class);
