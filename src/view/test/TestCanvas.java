...
public class TestCanvas extends Application {
    ...
    public final void start(final Stage stage) throws Exception {
        ...
        final GameView gv = new GameViewImpl(canvas);
        final AbstractPlayerView isaac = new IsaacView(gv);
        isaac.setX(300.0);
        isaac.setY(300.0);
        isaac.setHeight(85);
        isaac.setWidth(85);
        isaac.def(BasicMovementEnum.DOWN);
        final GaperView gaper = new GaperView(gv);
        gaper.setX(400.0);
        gaper.setY(400.0);
        gaper.setHeight(85);
        gaper.setWidth(85);
        gaper.def(BasicMovementEnum.DOWN);
        final KeyView rock = new KeyView(gv);
        rock.setX(200.0);
        rock.setY(200.0);
        rock.setHeight(30);
        rock.setWidth(30);
        final DoorView door = new DoorView(gv);
