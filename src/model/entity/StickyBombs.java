 ...
 */
public class StickyBombs extends AbstractPickupableEntity {
    private static final double WIDTH = 20;
    private static final double HEIGHT = 20;
    private static final int WEIGHT = 1;
    private final EntityEnum entityName = BasicEntityEnum.STICKY_BOMBS;
     ...
     * @param y 
     */
    public StickyBombs(final double x, final double y) {
        super();
        build(x, y);
    }
     ...
     * @param args 
     */
    public StickyBombs(final String args) {
        super();
